...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.H4(id='live-sensor-value', style={
                'font-size': '20px',
                'font-weight': 'bold',
                'color': '#28a745',
                'margin': '5px 0'
            }),
            html.H3('Maximum Sensor Value:', style={
                'color': '#333',
                'margin-bottom': '5px',
                'margin-top': '10px'
            }),
            html.H4(id='max-sensor-value', style={
                'font-size': '20px',
                'font-weight': 'bold',
                'color': '#dc3545',
                'margin': '5px 0'
        ...
        html.Div([
            html.H4('40% Max Value:', style={
                'font-size': '16px',
                'font-weight': 'bold',
                'color': '#333',
                'margin-bottom': '5px'
            }),
            html.H4(id='forty-percent', style={
                'font-size': '16px',
                'color': '#555',
                'margin': '5px 0'
            }),
            html.H4('60% Max Value:', style={
                'font-size': '16px',
                'font-weight': 'bold',
                'color': '#333',
                'margin-top': '5px'
            }),
            html.H4(id='sixty-percent', style={
                'font-size': '16px',
                'color': '#555',
                'margin': '5px 0'
            }),
            html.H4('80% Max Value:', style={
                'font-size': '16px',
                'font-weight': 'bold',
                'color': '#333',
                'margin-top': '5px'
            }),
            html.H4(id='eighty-percent', style={
                'font-size': '16px',
                'color': '#555',
                'margin': '5px 0'
            }),
    ...
    dcc.Interval(id='graph-update', interval=100, n_intervals=0),  # Adjusted interval to 100 ms
