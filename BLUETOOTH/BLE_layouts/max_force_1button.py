...
layout = html.Div([
    ...
    html.Div([
        ...
        html.Button('Stop Recording and Save Data', id='stop-and-save-button', n_clicks=0, style={'background-color': '#dc3545', 'color': '#fff', 'padding': '15px 32px', 'border': 'none', 'border-radius': '4px', 'font-size': '16px'})
