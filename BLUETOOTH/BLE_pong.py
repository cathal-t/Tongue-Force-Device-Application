// TODO: Change this code to work with BLE rather than SERIAL. 
// This code was added as placeholder to enable use of Dash application without errors.
...
ser = serial.Serial('COM6', 9600)  # Replace 'COM3' with your actual COM port
...
def handle_left_paddle_movement(sensor_value, left_paddle):
    # Convert sensor value to velocity
    max_sensor_value = 400/4 # Max sensor value from analogRead
    mid_value = max_sensor_value // 2

    # Calculate velocity based on sensor input
    if sensor_value > mid_value + 10:  # Allow small dead zone
        velocity = left_paddle.VEL + 12
    elif sensor_value < mid_value - 10:
        velocity = -left_paddle.VEL - 12
    else:
        velocity = 0
