...
from layouts import max_force, calibration, arcade, home, data_analysis, recording  # Import data_analysis layout
...
def display_page(pathname):
    ...
    elif pathname == '/recording':  # Add this condition
        return recording.layout  # Return the recording layout
...
recording_callbacks.register_callbacks(app)
