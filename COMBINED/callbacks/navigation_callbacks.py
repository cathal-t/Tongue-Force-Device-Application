...
def register_callbacks(app):
    ...
    @app.callback(
        ...
        [
            ...
            Input('recording-button', 'n_clicks'),  # Changed ID here
            Input('arcade-button', 'n_clicks')
        ]
    )
    def navigate_pages(max_force_clicks, calibration_clicks, recording_clicks, arcade_clicks):
        ...
        if button_id == 'max-force-button' and max_force_clicks > 0:
            ...
            return '/calibration'
        elif button_id == 'recording-button' and recording_clicks > 0:  # Fixed variable here
            return '/recording'
